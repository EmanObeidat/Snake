...
class GameMenu:
    ...
    def show_level_selection(self):
        ...
        while True:
            ...
            for i in range(3):
                level_button_surf = pygame.Surface((level_buttons[i].width, level_buttons[i].height), pygame.SRCALPHA)
                level_button_surf.fill((0, 255, 0, level_button_alpha))
                game_display.blit(level_button_surf, level_buttons[i])
